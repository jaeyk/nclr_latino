...
```{r}
latino_pre_black_bt <- get_bt_terms(1, 1, "black", 200)
asian_pre_black_bt <- get_bt_terms(0, 1, "black", 200)

latino_post_black_bt <- get_bt_terms(1, 0, "black", 200)
asian_post_black_bt <- get_bt_terms(0, 0, "black", 200)

latino_pre_disc_bt <- get_bt_terms(1, 1, "discrimination", 200)
asian_pre_disc_bt <- get_bt_terms(0, 1, "discrimination", 200)

latino_post_disc_bt <- get_bt_terms(1, 0, "discrimination", 200)
asian_post_disc_bt <- get_bt_terms(0, 0, "discrimination", 200)

latino_pre_compared_bt <- get_bt_terms(1, 1, "compared", 200)
asian_pre_compared_bt <- get_bt_terms(0, 1, "compared", 200)

latino_post_compared_bt <- get_bt_terms(1, 0, "compared", 200)
asian_post_compared_bt <- get_bt_terms(0, 0, "compared", 200)
```
